...
cmd 命令
fuseki-server --loc=G:\Geography-KG\Task_3\SpringMVC-Demo\GeoKG\src\main\resources\sysu_TDB /sysu
...
class JenaFuseki:
    def __init__(self, endpoint_url='http://localhost:3030/sysu/query'):
